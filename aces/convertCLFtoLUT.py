...
def write_CTL_1d(filename, 
    ...
    with open(filename, 'w') as fp:
        fp.write('// %d x %d LUT generated by "convertCLFtoLUT"\n' % (
          entries, components))
        fp.write('\n')
...
def main():
    ...
    usage += '\n'
    usage += 'Convert CLF to spi1d : --generate1d --lutResolution1d 1024 -c lut1d.clf -l lut1d.spi1d'
    usage += '\n'
    usage += 'Convert CLF to spi3d : --generate3d --lutResolution3d 33 33 33 -c lut3d.clf -l lut3d.spi3d'
    usage += '\n'
